...
\definecolor{ReclyBlue}{rgb}{0.04,0.55,0.75}
...
\newcommand{\highlightcolor}{ReclyBlue}
\newcommand{\headbarcolor}{DeepSkyBlue4!25}
\newcommand{\authorname}{Mohammad Nauman}
\newcommand{\authoremail}{\url{mohammad.nauman@nu.edu.pk}}
\newcommand{\authorweb}{http://csrdu.org/nauman}
\newcommand{\authoraffiliation}{Lecturer, Department of Computer Science \\ FAST National University of Computer and Emerging Sciences (FAST-NU) \\ Peshawar Campus}
\institute{http://csrdu.org/nauman}
\newcommand\slidesetdate{November 18, 2011}
% --------------------------------------
...
\begin{itemize} 
  ...
  \begin{itemize}
 	 \item an editor \cemph{({\TeX}nicCenter}, Kile, WinEdt, LED) 
  	 \item a compiler (\cemph{Mik{\TeX}}, {\TeX}Live, tetex ...)   
  \end{itemize}
