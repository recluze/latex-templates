...
% Minted styles for java, text 
\newminted[mintjava]{java}{xleftmargin=0pt,numbersep=5pt,fontsize=\footnotesize,linenos}%

\newminted[minttext]{text}{xleftmargin=0pt,numbersep=5pt,fontsize=\footnotesize,linenos}%

\newminted[mintbash]{bash}{xleftmargin=0pt,numbersep=5pt,fontsize=\footnotesize,linenos}%

\newminted[mintasm]{nasm}{xleftmargin=0pt,numbersep=5pt,fontsize=\footnotesize,linenos}%
