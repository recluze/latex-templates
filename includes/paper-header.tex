...
\newcommand{\putansline}[2]{\setcounter{forloopcounter}{1}\forloop{forloopcounter}{0}{\value{forloopcounter}< #1}{\par\vspace{\the\baselineskip}\dotfill}[#2]}
...
\textbf{Semester}:    & \semester    & \textbf{Total marks}: 
							  \totalmarks  & \textbf{Weight}: \weightmarks \\
